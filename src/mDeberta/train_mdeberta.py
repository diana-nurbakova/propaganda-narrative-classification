...
ARTIFACTS_PATH = os.environ.get('MDEBERTA_ARTIFACTS_DIR', 'mdeberta_artifacts_hierarchical/')
FINAL_MODEL_PATH = os.environ.get('MDEBERTA_MODEL_PATH', f'models/{MODEL_NAME}_narratives_classifier_hierarchical')
THRESHOLD = 0.5
MAX_LENGTH = 512
...
training_args = TrainingArguments(
    output_dir=os.environ.get('MDEBERTA_OUTPUT_DIR', './results_hierarchical'),
    num_train_epochs=MAX_EPOCHS,
    per_device_train_batch_size=int(os.environ.get('MDEBERTA_BATCH_SIZE', '8')),
    per_device_eval_batch_size=int(os.environ.get('MDEBERTA_BATCH_SIZE', '8')),
    gradient_accumulation_steps=int(os.environ.get('MDEBERTA_GRAD_ACCUM', '2')),
    learning_rate=2e-5,
    weight_decay=0.01,
    warmup_ratio=0.1,
    logging_dir=os.environ.get('MDEBERTA_LOGGING_DIR', './logs_hierarchical'),
    logging_steps=50,
    eval_strategy="epoch",
    save_strategy="epoch",
