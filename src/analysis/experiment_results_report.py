...
METHOD_DISPLAY = {
    ...
    "agora_5_majority": "Agora (5-agent majority)",
    "agora_7_majority": "Agora (7-agent majority)",
    "agora_union": "Agora (union)",
    "agora_5_union": "Agora (5-agent union)",
    "agora_7_union": "Agora (7-agent union)",
...
def parse_experiment_metadata(
    ...
    # IMPORTANT: longer prefixes must come before shorter ones
    # (e.g. agora_5_majority before agora_5, retrieval_agora before retrieval)
    known_methods = [
        "mdeberta_baseline",
        "agora_5_majority",
        "agora_7_majority",
